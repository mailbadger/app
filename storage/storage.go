...
type Storage interface {
	...
	LogFailedCampaign(c *entities.Campaign, log *entities.CampaignFailedLog) error
...
func LogFailedCampaign(c context.Context, ca *entities.Campaign, log *entities.CampaignFailedLog) error {
	return GetFromContext(c).LogFailedCampaign(ca, log)
}
