...
type Storage interface {
	...
	CreateUnsubscribedSubscriber(us *entities.UnsubscribeEvents) error
...
func CreateUnsubscribedSubscriber(c context.Context, us *entities.UnsubscribeEvents) error {
